...
//
// Bug original: `NoteModal.jsx` declaraba un `useMemo` (filteredClients)
// *después* del early return `if (!open) return null;`. React exige
// que los hooks se llamen en el mismo orden en cada render — al abrir
// el modal (open: false → true) el componente empezaba con 8 hooks y
// de pronto llamaba 9 → "Rendered more hooks than during the previous
// render". El modal se desmontaba silenciosamente sin pintar nada.
//
